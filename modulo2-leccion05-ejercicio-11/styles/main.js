...
/*function addPadding(){
    if(articleClass.classList.contains('js_padding')){
        articleClass.classList.add('js_main');
   } 
}
articleLink.addEventListener('click', addPadding);*/

function handleLink(event){
    event.preventDefault();}

articleLink.addEventListener('click', handleLink);   